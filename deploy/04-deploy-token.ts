...
const deployFunction: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  try {
    ...
    console.log("BToken already initialized: ");
  }
  ...
  try {
    ...
    console.log("DelegationAwareBToken already initialized: ");
  }
  ...
  try {
    ...
    console.log("StableDebtToken already initialized: ");
  }
  ...
  try {
    ...
    console.log("VariableDebtToken already initialized: ");
  }
