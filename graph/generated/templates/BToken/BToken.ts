...
export class BToken__getScaledUserBalanceAndSupplyResult {
  value0: BigInt;
  value1: BigInt;
...
export class BToken extends ethereum.SmartContract {
  ...
  BTOKEN_REVISION(): BigInt {
    let result = super.call(
      "BTOKEN_REVISION",
      "BTOKEN_REVISION():(uint256)",
      [],
    );
  ...
  try_BTOKEN_REVISION(): ethereum.CallResult<BigInt> {
  ...
  getScaledUserBalanceAndSupply(
    user: Address,
  ): BToken__getScaledUserBalanceAndSupplyResult {
    let result = super.call(
      "getScaledUserBalanceAndSupply",
    ...
    return new BToken__getScaledUserBalanceAndSupplyResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_getScaledUserBalanceAndSupply(
    user: Address,
  ): ethereum.CallResult<BToken__getScaledUserBalanceAndSupplyResult> {
    let result = super.tryCall(
      "getScaledUserBalanceAndSupply",
      "getScaledUserBalanceAndSupply(address):(uint256,uint256)",
      [ethereum.Value.fromAddress(user)],
    ...
    return ethereum.CallResult.fromValue(
      new BToken__getScaledUserBalanceAndSupplyResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
