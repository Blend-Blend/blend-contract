...
export class Pool extends ethereum.SmartContract {
  ...
  repayWithBTokens(
    ...
    let result = super.call(
      "repayWithBTokens",
      "repayWithBTokens(address,uint256,uint256):(uint256)",
      [
        ethereum.Value.fromAddress(asset),
        ethereum.Value.fromUnsignedBigInt(amount),
        ethereum.Value.fromUnsignedBigInt(interestRateMode),
...
export class RepayWithBTokensCall extends ethereum.Call {
  get inputs(): RepayWithBTokensCall__Inputs {
    return new RepayWithBTokensCall__Inputs(this);
  }

  get outputs(): RepayWithBTokensCall__Outputs {
    return new RepayWithBTokensCall__Outputs(this);
  }
}

export class RepayWithBTokensCall__Inputs {
  _call: RepayWithBTokensCall;

  constructor(call: RepayWithBTokensCall) {
    this._call = call;
  }
...
export class RepayWithBTokensCall__Outputs {
  _call: RepayWithBTokensCall;
