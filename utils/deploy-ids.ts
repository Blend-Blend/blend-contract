...
export const BTOKEN_IMPL_ID = `BToken-${MARKET_NAME}`;
export const DELEGATION_AWARE_BTOKEN_IMPL_ID = `DelegationAwareBToken-${MARKET_NAME}`;
...
export const ORACLE_ID = `ProtocolOracle-${MARKET_NAME}`;
...
export const BLEND_COLLECTOR_PROXY_ID = `BlendCollector-${PROXY_ID}-${MARKET_NAME}`;
export const BLEND_COLLECTOR_IMPL_ID = `BlendCollector-${IMPL_ID}-${MARKET_NAME}`;
...
export const BTOKEN_PREFIX = `-BToken-${MARKET_NAME}`;
...
export const STAKE_BLEND_PROXY = `StakeBlend-${PROXY_ID}`;
export const STAKE_BLEND_IMPL_V1 = `StakeBlend-REV-1-${IMPL_ID}`;
export const STAKE_BLEND_IMPL_V2 = `StakeBlend-REV-2-${IMPL_ID}`;
export const STAKE_BLEND_IMPL_V3 = `StakeBlend-REV-3-${IMPL_ID}`;
