...
export const CommonsConfig: ICommonConfiguration = {
  MarketId: "Commons Blend Market",
  BTokenNamePrefix: "Blend",
  StableDebtTokenNamePrefix: "Blend",
  VariableDebtTokenNamePrefix: "Blend",
  SymbolPrefix: "Btc",
  ProviderId: 0,
  ...
  ChainlinkAggregator: {
    [eEthereumNetwork.main]: {
      BLEND: "0x547a514d5e3769680Ce22B2361c10Ea13619e8a9",
